...
// configuration step. It creates a namespace called `cppweekly-game-jam`. You can modify
...
int main(int argc, const char **argv)
{
 ...
 Options:
    ...
    std::map<std::string, docopt::value> args = docopt::docopt(USAGE,
      ...
      fmt::format("{} {}",
        cppweekly-game-jam::cmake::project_name,
        cppweekly-game-jam::cmake::project_version));// version string, acquired
